    ...
    return (
        <div className={s.preloader}>
            <svg xmlns="http://www.w3.org/2000/svg" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="1">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.875">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.75">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.625">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.5">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.375">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.25">
                ...
                <circle cx="0" cy="0" r="6" fill="#004d47" fill-opacity="0.125">
